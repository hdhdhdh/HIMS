...
public interface IAppointmentDao
{
    ...
    public void updateAppointmentStatus(@Param("d_id") int d_id);//医生更新预约状态
    public List<Appointment> getAllUnprocessedAppointment(@Param("p_id") String p_id);//得到未处理的预约信息
